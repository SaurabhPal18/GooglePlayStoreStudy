...
#    df.to_excel('dict1.xlsx')
    ...
    data2=pd.read_excel("C:\Project12\dict1.xlsx", sep='\t', header=None)
...
def point_9():
    ...
    data3=pd.read_csv("C:\Datasheets\data.csv")
...
#        print('{:.1f}{}'.format(n / 10**(3 * millidx), millnames[millidx]))
    ...
    for bar in quater_installs:
        ...
        yval=int(yval)
#        millify(yval)
        plt.text(bar.get_x() - .3, yval - .0, str(yval)+"  ",fontsize=7)
...
def point_13():
    ...
    newdata1=pd.read_csv("C:\Datasheets\googleplaystore_user_reviews.csv")
...
def register():
    ...
    Label(screen1, text="Geneure:", font=("Open Sans", 11, 'bold'), fg='white',bg='#174873', anchor=W).place(x=0, y=510)
...
def main_screenok():
    ...
    photo=PhotoImage(file="imageapp.png")
...
def main_screen():
    ...
    adjustwindow(screen)
    Button(screen,text=" Percentage download in each category",bg="#440c8d",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_1).place(x=30,y=30+30+30)
#    Button(screen,text="Data Entry",height=1,width=83,bg='#e79700',font=("Open Sans",13,'bold'),fg='white',command=register).place(x=30,y=446+92)
    Button(screen,text=" Percentage download in each category",bg="#440c8d",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_1).place(x=30,y=30+30+30)
    Button(screen,text="Apps as per downloads",bg="#440c8d",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_2).place(x=30,y=62+30+30)
    Button(screen,text="Most and Least downloads by an category",bg="#c0e7f6",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_3).place(x=30,y=94+30+30)       
    Button(screen,text="Category managed to get the highest maximum average ratings",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_4).place(x=30,y=126+30+30)
    ...
    Button(screen,text="category got Most & Least Download(2016,2017,2018)",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_6).place(x=30,y=190+30+30)
    Button(screen,text="Apps with Maximum Compatibility",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_7).place(x=30,y=222+30+30)
    #Button(mainscreen,text="Feature 8",bg="#e79700",width=60,height=1,font=("Open Sans",13,'bold'),fg="white").place(x=30,y=30)
    Button(screen,text="Apps 1,00,000+ downloads and rated 4.1 or above",bg="#194775",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_9).place(x=30,y=254+30+30)
    Button(screen,text="quaterly download of each year",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),command=point_11,fg="white").place(x=30,y=286+30+30)
    ...
    Button(screen,text="Apps generated most Positive, Negative & equal Sentiments",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_12).place(x=30,y=350+30+30)
    Button(screen,text="Relation B/W Sentiment-polarity & Sentiment-subjectivity",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_13).place(x=30,y=382+30+30)
    Button(screen,text="Month having highest average download by apps",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_16).place(x=30,y=414+30+30)
    Button(screen,text="Relation between size and Installs",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_17).place(x=30,y=446+30+30)
    Button(screen,text="Next",bg="#66dda5",width=20,height=1,font=("Open Sans",10,'bold'),fg="white",command=main_screenok).place(x=900,y=550)       
    Button(screen,text="10 best food App",bg="#66dda5",width=83,height=1,font=("Open Sans",13,'bold'),fg="white",command=point_15).place(x=30,y=478+30+30)       
